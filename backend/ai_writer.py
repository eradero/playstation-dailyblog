...
def generate_blog_post(original_title, original_content):
    ...
    prompt = f"""
        Eres un periodista experto en videojuegos. Reescribe la noticia para un blog fan de PS5 con tono entusiasta y amigable.
        ...
        [AFFILIATE_LINK]
        (Genera un link de búsqueda de Amazon para el juego y la consola PS5. IMPORTANTE: El link DEBE terminar con &tag=blogseradero-20 para que sea válido)
        [CONTENIDO]
